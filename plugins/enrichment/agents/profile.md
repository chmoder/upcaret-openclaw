...
1. Search with one focused query. Evaluate the top results and select up to 3 promising links.
...
- Maximum 3 full search cycles ("start over" at most twice after the first cycle).
